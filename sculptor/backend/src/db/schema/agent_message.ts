...
// exposes full history; rows are NEVER mutated — the projection folds them.
// object_id is the message's own id (= message.message_id); the writer enforces
// the object_id/source/is_partial invariants the Python model_post_init checked.
// task_id is renamed agent_id.
