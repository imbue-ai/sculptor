...
The diff panel can show `.md` and `.markdown` files either as rendered HTML
via react-markdown (the default) or as raw source (the Pierre/Shiki view). The
toggle lives in the diff tab bar and is only visible when ReadOnlyPreview is the
