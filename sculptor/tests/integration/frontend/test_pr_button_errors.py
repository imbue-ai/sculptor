...
def _cleanup_workspaces(instance: SculptorInstance) -> None:
    """Delete all workspaces and open the new-workspace modal for the next scenario.
    ...
    sees __home__ as the active tab and redirects there. Explicitly open the
    new-workspace modal so the create surface is ready before any subsequent
    reload.
    """
