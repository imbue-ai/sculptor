...
class TestRemoveCommandInputUserMessage(MigrationTestFixture):
    """Test fixture for the migration that removes CommandInputUserMessage and related rows."""
    ...
    def seed(self, connection: sa.engine.Connection) -> None:
        ...
        # Insert saved_agent_messages with different object_types
        messages = [
            ("snap-msg-1", "msg-1", "CommandInputUserMessage"),
            ("snap-msg-2", "msg-2", "UserCommandFailureAgentMessage"),
            ("snap-msg-3", "msg-3", "ChatInputUserMessage"),
        ]
