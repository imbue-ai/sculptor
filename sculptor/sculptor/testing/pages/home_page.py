...
class PlaywrightHomePage(PlaywrightIntegrationTestPage):
    ...
    def get_empty_state(self) -> Locator:
        # The home list's "No workspaces yet" heading. With zero workspaces
        # Home also auto-opens the new-workspace dialog over it; the heading
        # underneath stays CSS-visible.
