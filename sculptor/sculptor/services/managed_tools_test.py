...
# Verified darwin-arm64 sha256 for pi 0.84.3; ``just bump-pi <version>`` refreshes it.
_PI_DARWIN_ARM64_SHA256_0_84_3 = "0120c9f99ea05fe801e6e7c2c9d91dd65636563ca0803711b37b9f32920d4b63"
...
def test_pi_pin_darwin_arm64_sha256_matches_the_verified_value() -> None:
    assert PI_PIN.platforms["darwin-arm64"].sha256 == _PI_DARWIN_ARM64_SHA256_0_84_3
