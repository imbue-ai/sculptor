...
type AlphaExpandedToolRowProps = {
  pillData: PillData;
 ...
 * the call site.
 */
const AlphaExpandedToolRowImpl = forwardRef<HTMLDivElement, AlphaExpandedToolRowProps>(
...
AlphaExpandedToolRowImpl.displayName = "AlphaExpandedToolRow";

export const AlphaExpandedToolRow = memo(AlphaExpandedToolRowImpl);

// Shared row branch for shell-command-style tools (Bash, Monitor). Their
// primary popover (AlphaCommandPopover) shows description + duration in
