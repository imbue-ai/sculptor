...
import { isSplitHalfAtom } from "~/pages/workspace/layout/atoms/section.ts";
import { closeSplitAtom } from "~/pages/workspace/layout/atoms/sectionActions.ts";
import { recentlyClosedPanelIdsAtom } from "~/pages/workspace/layout/atoms/transient.ts";
...
import type { AvailableStaticPanel } from "~/pages/workspace/layout/utils/layoutQueries.ts";
