...
import { setSplitRatioAtom, SPLIT_RATIO_MAX, SPLIT_RATIO_MIN } from "~/pages/workspace/layout/atoms/sectionActions.ts";
import type { SectionId } from "~/pages/workspace/layout/types/section.ts";
import { primaryOf, toSecondary } from "~/pages/workspace/layout/types/section.ts";
