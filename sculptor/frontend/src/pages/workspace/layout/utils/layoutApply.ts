...
// would close. No atoms, no React, no DOM — the write actions in
// atoms/savedLayoutActions.ts wrap these, and they are directly unit-testable.
//
...
import { isSecondary, toSection } from "~/pages/workspace/layout/types/section.ts";
...
export const applyCapturedLayout = (current: WorkspaceLayoutState, captured: CapturedLayout): ApplyLayoutResult => {
...
export const seedWorkspaceFromDefault = (
  base: WorkspaceLayoutState,
...
export const computeTidyClosure = (layout: WorkspaceLayoutState, captured: CapturedLayout): Array<TidyClosureEntry> => {
