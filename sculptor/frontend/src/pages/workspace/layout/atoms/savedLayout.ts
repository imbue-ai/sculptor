...
// the atoms/sidebar.ts slice pattern: each is a narrow read/write view of one field
...
// savedLayoutActions.ts; these are the plumbing they build on.
...
import {
  ...
  SYSTEM_LAYOUTS,
} from "~/pages/workspace/layout/utils/systemDefaultLayout.ts";

import { globalLayoutAtom, workspaceLayoutAtom } from "./section.ts";
