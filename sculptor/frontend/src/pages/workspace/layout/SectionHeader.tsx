...
import type { PanelContextMenuItem, PanelDefinition } from "~/pages/workspace/layout/registry/panelRegistry.ts";
import {
  panelDefinitionByIdAtom,
  panelRegistryAtom,
  resolvedActivePanelIdInSubSectionAtom,
} from "~/pages/workspace/layout/registry/panelRegistry.ts";
import { isMultiInstanceKind } from "~/pages/workspace/layout/registry/panelRegistry.ts";
import type { PanelId, SubSectionId } from "~/pages/workspace/layout/types/section.ts";
import { splitDirectionOptionsForSection, toSection } from "~/pages/workspace/layout/types/section.ts";
