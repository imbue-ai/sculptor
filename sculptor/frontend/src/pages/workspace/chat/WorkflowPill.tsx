...
import styles from "./SubagentPill.module.scss";
...
import popoverStyles from "./WorkflowPopover.module.scss";
import { WorkflowPopover } from "./WorkflowPopover.tsx";
...
export const WorkflowPill = ({ toolUseId, block, result, rowIndex }: WorkflowPillProps): ReactElement => {
  ...
  // ToolNavigationProvider. Mirrors SubagentPill.
  ...
  return (
    <Popover.Root open={isOpen} onOpenChange={setOpen}>
      ...
      >
        <WorkflowPopover state={state} displayName={displayName} result={result} />
      </Popover.Content>
    </Popover.Root>
  );
};
