...
import { ChatBlockquote } from "./ChatBlockquote.tsx";
import { ChatCodeBlock } from "./ChatCodeBlock.tsx";
import styles from "./ChatMarkdownBlock.module.scss";
...
export const ChatMarkdownBlock = memo(
  ({
    content,
    ...
    showCursor = false,
  }: ChatMarkdownBlockProps): ReactElement => {
    ...
    // would treat ChatTable / ChatCodeBlock as new component types and
