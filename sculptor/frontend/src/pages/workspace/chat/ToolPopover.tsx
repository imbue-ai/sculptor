 ...
 * controls layout — popover-entry chrome by default; ToolPillRow
...
export const ToolPopover = ({ pillData, workspaceCodePath = null }: ToolPopoverProps): ReactElement => {
