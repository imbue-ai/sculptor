...
describe("useChatScrollPersistence", () => {
  ...
  it("scrolls to the padded max scroll on first visit (no saved position)", () => {
    ...
    renderHook(() => useChatScrollPersistence(ref, virtualizer, "agent-1", messages, createScrollStateMachine()), {
  ...
  it("drives the machine through restoring -> userControlled", () => {
    ...
    renderHook(() => useChatScrollPersistence(ref, virtualizer, "agent-1", messages, machine), {
      wrapper: wrapperFor(store),
    });
