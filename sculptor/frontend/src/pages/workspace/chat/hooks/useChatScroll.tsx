...
// A single subscription point for "the chat just scrolled" events.
...
type ChatScrollProviderProps = {
  ...
  // Owned by `useChatAutoScroll`. True for ~150ms after a wheel / touch /
...
// Calls `onClose` whenever the chat scroll container fires a
