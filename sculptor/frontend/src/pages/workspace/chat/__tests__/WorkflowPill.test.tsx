...
import type * as UseAgentDetailModule from "~/common/state/hooks/useAgentDetail.ts";

import { WorkflowPill } from "../WorkflowPill.tsx";

let mockWorkflowTaskStates: Record<string, WorkflowTaskState> = {};

vi.mock("~/common/state/hooks/useAgentDetail.ts", async (importOriginal) => {
...
const renderPill = (): ReturnType<typeof render> =>
  render(<WorkflowPill toolUseId={TOOL_USE_ID} block={makeBlock()} />, { wrapper: Wrapper });
