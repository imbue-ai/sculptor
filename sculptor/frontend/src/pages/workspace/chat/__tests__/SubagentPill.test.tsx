...
vi.mock("../SubagentPopover.tsx", () => ({
  SubagentPopover: (): ReactElement => <div data-testid="subagent-popover" />,
}));
...
describe("SubagentPill", () => {
  ...
  describe("keyboard navigation", () => {
    ...
    it("falls back to local state when no ToolNavigationProvider wraps it", () => {
      ...
      // The mocked SubagentPopover renders a div with this testid when open.
