...
vi.mock("~/pages/workspace/diffPanel/usePierreHighlighterReady.ts", () => ({
...
const renderPopover = (chipData: ChipData): ReactElement => (
  <ChatAgentProvider workspaceId="ws-test" agentId="agent-1">
    <Theme>
      <ChipDiffPopover chipData={chipData} onClose={(): void => {}} onNavigate={(): void => {}} />
    </Theme>
  </ChatAgentProvider>
);
...
describe("ChipDiffPopover.handleOpenDiffPanel routing (SCU-366)", () => {
