...
vi.mock("../ChipDiffPopover.tsx", () => ({
  ChipDiffPopover: (): ReactElement => <div data-testid="diff-popover">Diff popover</div>,
}));
...
type ChipRowProps = React.ComponentProps<typeof ChipRow>;
...
const renderChipRow = (overrides: Partial<ChipRowProps> = {}): ReturnType<typeof render> => {
  ...
  return render(<ChipRow {...defaultProps} />, { wrapper: WrapperWithStore });
};
