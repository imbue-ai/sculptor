...
import type { ChipDiffPopoverActions } from "./ChipDiffPopover.tsx";
...
export const ChipRow = ({
  ...
  // Mirrors ToolPillRow: the setter is wrapped to keep localIsPinnedRef
        ...
        <PopoverAnchor>
          ...
          >
            {chipDataList.map((chip, index) => (
              ...
              // same pattern ToolPillRow uses for tool pills.
              <span
                key={chip.id}
