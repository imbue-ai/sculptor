...
import styles from "./ChipDiffPopover.module.scss";
...
export const ChipDiffPopover = ({ chipData, onClose, onNavigate, actionRef }: ChipDiffPopoverProps): ReactElement => {
