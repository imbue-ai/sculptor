...
import { splitAnswerIntoParts } from "~/pages/workspace/chat/utils/askUserQuestion";

import styles from "./AskUserQuestionBlock.module.scss";
...
export const AskUserQuestionBlock = ({ toolBlock }: { toolBlock: ToolUseBlock }): ReactElement => {
