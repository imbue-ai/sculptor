...
import styles from "./ContextSummary.module.scss";

const POPOVER_STYLE: CSSProperties = { padding: 0, width: 560, maxHeight: 480 };

const HINT_PREVIEW_LENGTH = 80;

export const ContextSummary = ({ text, label }: { text: string; label: string }): ReactElement => {
      ...
      >
        <div className={styles.popoverBody}>
          ...
          <div className={styles.content}>
            <ChatMarkdownBlock content={text} />
          </div>
        </div>
      </Popover.Content>
    </Popover.Root>
