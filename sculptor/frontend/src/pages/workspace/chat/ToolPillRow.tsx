...
import { ExpandedToolRow } from "./ExpandedToolRow.tsx";
...
export const ToolPillRow = ({
  blocks,
  toolResultMap,
  inProgressMessageId,
  rowIndex,
}: ToolPillRowProps): ReactElement | null => {
  ...
  // Per-pill stable callbacks. Memoized so ExpandedToolRow (wrapped in
  ...
  const renderPopoverContent = (pill: PillData): ReactElement => {
    ...
    return <ToolPopover pillData={pill} workspaceCodePath={workspaceCodePath} />;
  };
