...
export const ChangesPill = ({ onReviewAll }: ChangesPillProps): ReactElement | null => {
  ...
  // Provider-aware labels, mirroring the desktop PR button (MR/! on GitLab).
  const isGitLab = workspace != null && git.prTerm(workspace) === "merge request";
  const prTerm = isGitLab ? "MR" : "PR";
