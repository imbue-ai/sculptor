...
import { FileChip } from "~/pages/workspace/chat/FileChip.tsx";
...
const largeStatsChip: ChipData = {
  id: "tool-005",
  filePath: "src/pages/workspace/chat/ChatView.tsx",
  displayName: "chat/ChatView.tsx",
  state: "completed",
...
const meta = {
  title: "Chat/File Chips/FileChip",
  component: FileChip,
  decorators: [
    (Story): ReactElement => (
