...
import { ChatAgentProvider } from "~/pages/workspace/chat/ChatAgentContext.tsx";
import { ChipDiffPopover } from "~/pages/workspace/chat/ChipDiffPopover.tsx";
import type { ChipData } from "~/pages/workspace/chat/chipRow.types.ts";
...
const longPathChip: ChipData = {
  id: "tool-005",
  filePath: "sculptor/frontend/src/pages/workspace/chat/ChipDiffPopover.tsx",
  displayName: "ChipDiffPopover.tsx",
  state: "completed",
  stats: { added: 155, removed: 0 },
  isNewFile: true,
  blocks: [{ type: "tool_use", id: "tool-005", name: "Write", input: {} }],
  results: [makeResult(newFileDiff, "sculptor/frontend/src/pages/workspace/chat/ChipDiffPopover.tsx")],
  errorDetail: null,
  errorContentType: null,
};
      ...
      <Route
        ...
        element={
          <ChatAgentProvider workspaceId="storybook-ws" agentId="storybook-agent">
            ...
            >
              <ChipDiffPopover chipData={chipData} onClose={onClose} onNavigate={onNavigate} />
            </div>
          </ChatAgentProvider>
        }
      />
...
const meta = {
  title: "Chat/File Chips/ChipDiffPopover",
  component: Wrapper,
  decorators: [
    (Story): ReactElement => (
