...
import chatStyles from "~/pages/workspace/chat/ChatView.module.scss";
import { PulsingDot } from "~/pages/workspace/chat/pillAnimations";
import { TurnFooter } from "~/pages/workspace/chat/TurnFooter";
