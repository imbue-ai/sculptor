...
import { ChipRow } from "~/pages/workspace/chat/ChipRow.tsx";
      ...
      <Route
        ...
        element={
          <div style={{ maxWidth: "600px" }}>
            <ChipRow blocks={blocks} toolResultMap={toolResultMap} inProgressMessageId={inProgressMessageId} />
          </div>
        }
      />
    </Routes>
