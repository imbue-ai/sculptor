...
import { globalLayoutAtom } from "~/pages/workspace/layout/atoms/section.ts";
import type { SidebarOrderState } from "~/pages/workspace/layout/persistence/snapshot.ts";
