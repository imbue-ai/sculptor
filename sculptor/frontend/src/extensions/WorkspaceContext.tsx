 ...
 * workspace. Lets the SDK's hooks (e.g. `useWorkspaceAgents`) read the current
...
export const useWorkspaceExtensionContext = (): WorkspaceExtensionContextValue => {
  ...
  if (!ctx) {
    throw new Error(
      "Extension SDK: useWorkspaceAgents called outside a workspace extension mount. It requires the host's " +
