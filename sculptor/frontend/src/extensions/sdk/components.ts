/**
 * Sculptor first-party components extensions can use. The generated SDK runtime
 * stub (served at `/extension-runtime/sculptor-extension-sdk.js`) re-exports these
...
// code blocks get copy buttons) — so extensions can show rich text from external
