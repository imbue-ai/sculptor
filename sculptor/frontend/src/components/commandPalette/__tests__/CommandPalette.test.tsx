...
import { commandPaletteOpenAtom, commandPalettePagesAtom, commandPalettePendingAtom } from "../atoms/commandPalette.ts";
...
describe("CommandPalette", () => {
  ...
  it("opens directly to a sub-page when seeded via commandPaletteInitialPageAtom (Cmd+P flow)", async () => {
    ...
    const { commandPaletteInitialPageAtom } = await import("../atoms/commandPalette.ts");
