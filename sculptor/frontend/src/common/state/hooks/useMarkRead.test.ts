...
describe("useMarkRead", () => {
  it("flushes a pending debounced read when the agent is left mid-debounce", async () => {
    seedTask(makeAgent("2024-01-01T00:00:05.000Z", "2024-01-01T00:00:01.000Z"));
    ...
    await writeTaskAndNotify(makeAgent("2024-01-01T00:00:06.000Z", "2024-01-01T00:00:01.000Z"));
  ...
  it("preserves an explicit mark-unread on the agent being left when switching agents", async () => {
    seedTask(makeAgent("2024-01-01T00:00:05.000Z", "2024-01-01T00:00:01.000Z", "agent-x"));
    seedTask(makeAgent("2024-01-01T00:00:05.000Z", "2024-01-01T00:00:01.000Z", "agent-y"));
    ...
    await writeTaskAndNotify(makeAgent("2024-01-01T00:00:06.000Z", "2024-01-01T00:00:01.000Z", "agent-x"));
