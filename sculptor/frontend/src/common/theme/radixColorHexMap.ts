 ...
 * Sourced from @radix-ui/colors CSS files.
 */
type ColorScale = ReadonlyArray<string>;

type ColorModeScales = {
  light: ColorScale;
  dark: ColorScale;
};
...
/**
 * Maps accent colors to their matching gray color (same as Radix's getMatchingGrayColor).
 */
const AUTO_GRAY_MAP: Record<AccentColor, string> = {
  tomato: "mauve",
  red: "mauve",
  ruby: "mauve",
  crimson: "mauve",
...
/**
 * Resolves the "auto" gray color to the matching gray based on the accent color.
 */
export const resolveGrayColor = (grayColor: GrayColor, accentColor: AccentColor): string => {
  if (grayColor === "auto") {
    return AUTO_GRAY_MAP[accentColor];
  }
  return grayColor;
};
