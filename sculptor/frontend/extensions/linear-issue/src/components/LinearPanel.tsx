...
import { PanelHeader, useCurrentWorkspace, useExtensionSetting } from "@sculptor/extension-sdk";
...
export const LinearPanel = (): ReactElement => {
  ...
  return (
    <Flex direction="column" height="100%">
      ...
      {!apiKey ? (
        <EmptyState message="Add your Linear API key in the extension settings to link branches to issues." />
      ) : (
