...
![Files panel on the Changes tab, with a file's diff open in the main view](../images/changes-panel.png)
...
![Commit button in the Changes tab showing the pending change count](../images/commit-button.png)
