...
- **REQ-COMPAT-020 (MUST).** **Claude CLI** is required. Compatibility window: **recommended 2.1.280,
  minimum 2.1.280, maximum 2.99.99, blocked 2.1.101**; supported platforms **darwin-arm64** and
