...
- **[User guide](help/)** — how to *use* Sculptor: workspaces, agents, chat,
...
- **[Competitors](competitors.md)** — how Sculptor compares to other coding
  agents, and why we built it.

For the project overview and quickstart, see the [top-level README](../README.md).
