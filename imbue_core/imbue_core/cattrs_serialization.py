...
# NOTE: Types such as LRUCache will always serialize without errors since they inherit from Mapping but will not deserialize correctly.
...
def _deserialize_enum(data: dict[str, str] | str, t: type) -> Any:
    ...
    # {"__type": "...", "value": "..."}. Yasoo converted this dictionary into a string
...
def _serialize_to_json_dumpable_object(
    ...
    # HACK: this makes it possible to serialize ExecutionContexts for calls to
    #  class methods without serializing the class itself.
