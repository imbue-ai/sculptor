...
source) the first time the backend starts, so "Claude" (marked "in terminal"
in the pickers) appears in the `+` menu's type list and in the new-workspace
agent picker out of the box.
